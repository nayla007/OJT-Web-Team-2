...
export default function DaftarPelatihanEdit() {
  ...
  const handleUpdate = async (e) => {
    ...
    axios
      .put(`http://localhost:5000/daftar-pelatihan-edit/${id}`, {
    ...
    <section className="bg-light py-5 mt-3">
      <form onSubmit={handleUpdate}>
        <div className="container">
          ...
          <div className="mb-3 row">
            <label htmlFor="materi_pembelajaran" className="col-sm-2 col-form-label">
              Materi Pembelajaran
            </label>
            <div className="col-sm-10">
              <input
          ...
          <div className="mb-3 row">
            <label htmlFor="metode_pembelajaran" className="col-sm-2 col-form-label">
              Metode Pembelajaran
            </label>
            <div className="col-sm-10">
              <input
